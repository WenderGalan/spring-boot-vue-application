        ...
        methods: {
            ...
            addTodo: function () {
                ...
                api.createNew(value, false).then( (response) => {
                    this.$log.debug("Novo item criado:", response);
                    this.todos.push({
                        id: response.data.id,
                        title: value,
                        completed: false
            ...
            completeTodo (todo) {
                api.updateForId(todo.id, todo.title, todo.completed).then((response) => {
                    this.$log.info("Item atualizado:", response.data);
                }).catch((error) => {
                    this.$log.debug(error)
            ...
            removeTodo: function (todo) { // notice NOT using "=>" syntax
                api.removeForId(todo.id).then(() => { // notice AM using "=>" syntax
                    this.$log.debug("Item removido:", todo);
            ...
            doneEdit: function (todo) {
                ...
                this.$log.info("Item atualizado:", todo);
